...
public final class InventoryInspectionMenu
    ...
    public static final int TARGET_INFO_SLOT = 49;
    public static final int CLOSE_SLOT = 50;

    private final Container menuContainer;
    private final UUID targetUuid;
    private final int browserPage;
    private final InspectionReturnTarget returnTarget;

    public InventoryInspectionMenu(
            int containerId,
    ...
    public void clicked(
        ...
        switch (slotId) {
            ...
            default -> {
                // Inventory snapshots and informational slots are read-only.
            }
        }
    }
